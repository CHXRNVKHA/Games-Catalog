...
export class InMemoryDataService {
  public createDb() {
    const games = [
      ...
      { id: 4, name: 'Uncharted3',  date:'2016 May 10', raiting: 94.4, description: 'desc', imageUrl: '.../../../assets/images/Uncharted_4_cover.jpg'},
      { id: 5, name: 'Uncharted4',  date:'2016 May 10', raiting: 94.4, description: 'desc', imageUrl: '.../../../assets/images/Uncharted_4_cover.jpg'},
      { id: 6, name: 'Uncharted5',  date:'2016 May 10', raiting: 94.4, description: 'desc', imageUrl: '.../../../assets/images/Uncharted_4_cover.jpg'},
      { id: 7, name: 'Uncharted6',  date:'2016 May 10', raiting: 94.4, description: 'desc', imageUrl: '.../../../assets/images/Uncharted_4_cover.jpg'},
      { id: 8, name: 'Uncharted7',  date:'2016 May 10', raiting: 94.4, description: 'desc', imageUrl: '.../../../assets/images/Uncharted_4_cover.jpg'},
    ];
    const users = [
